      ...
      <div class="team-grid">
        ...
        >
          ...
          <div class="member-info">
            ...
            <p
              v-if="member.bio && data.style === 'cards'"
              class="member-bio"
            >
              {{ member.bio }}
            </p>
...
/* Cards Style */
.style-cards .team-section {
  background: white;
}

.style-cards .team-member {
  background: #f9fafb;
  border-radius: 1rem;
  padding: 2rem 1.5rem;
}

.style-cards .team-member:hover {
  background: white;
  box-shadow: 0 10px 40px rgba(0, 0, 0, 0.08);
}

.style-cards .member-image {
  width: 120px;
  height: 120px;
}

/* Minimal Style */
.style-minimal .member-image {
  width: 80px;
  height: 80px;
}

.style-minimal .team-grid {
  gap: 1.5rem;
}

.style-minimal .member-name {
  font-size: 1rem;
}

.style-minimal .member-role {
  font-size: 0.875rem;
}
