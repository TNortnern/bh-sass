/**
 * Coastal Template - Liability Waiver Page
 */
...
<section class="py-16 bg-gradient-to-b from-sky-50 to-white">
  <div class="container">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-8 lg:p-12 border border-sky-100">
      ...
      <div class="mt-8 text-center">
        ...
        <p class="text-slate-500 text-sm mt-2">
          Questions? <a href="/contact" class="text-sky-600 font-semibold hover:underline">Contact us</a>
        </p>
      </div>
    </div>
  </div>
