  ...
  <div class="container">
    <div class="max-w-4xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-8">
          <div class="bg-gradient-to-br from-sky-500 to-cyan-600 rounded-2xl p-8 text-white">
            ...
            <div class="space-y-4">
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="text-sky-100">(555) 123-4567</p>
                </div>
              </div>
              <div class="flex items-center gap-4">
                <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <p class="text-sky-100">info@example.com</p>
                </div>
              </div>
              <div class="flex items-center gap-4">
                <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <p class="text-sky-100">Within 30 miles</p>
                </div>
              </div>
            </div>
          </div>

          <div class="bg-white rounded-2xl p-6 border border-sky-100">
            <h3 class="font-bold text-slate-900 mb-3">Business Hours</h3>
            <div class="space-y-2 text-slate-600">
              ...
              <div class="flex justify-between">
                <span>Saturday</span>
                <span class="font-medium">8am - 8pm</span>
              </div>
              <div class="flex justify-between">
                <span>Sunday</span>
