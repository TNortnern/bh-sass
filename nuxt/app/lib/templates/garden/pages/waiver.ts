...
<section class="py-16 bg-gradient-to-r from-emerald-600 to-teal-600">
  <div class="container text-center">
    <h1 class="text-4xl lg:text-5xl font-bold text-white mb-4">Liability Waiver</h1>
    <p class="text-xl text-emerald-100 max-w-2xl mx-auto">Safety first! Please sign before your event.</p>
  </div>
</section>
      `.trim()
    },
      ...
      <div class="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 mb-8">
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-emerald-700">All equipment is inspected and sanitized before every rental. We're fully licensed and insured.</p>
          </div>
        </div>
      </div>
      <div class="bg-white rounded-2xl shadow-lg p-8 lg:p-12 border border-emerald-100">
