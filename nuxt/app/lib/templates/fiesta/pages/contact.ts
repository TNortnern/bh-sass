  ...
  <div class="container">
    <div class="max-w-4xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-8">
          <div class="bg-gradient-to-br from-orange-500 to-rose-500 rounded-2xl p-8 text-white">
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="text-orange-100">info@example.com</p>
                </div>
              </div>
              <div class="flex items-center gap-4">
                <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <p class="text-orange-100">Within 30 miles</p>
                </div>
              </div>
            </div>
          </div>
