    ...
    <div class="flex items-start justify-between gap-4 mb-8">
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400">
          Build and customize your professional rental website
        </p>
      </div>
      ...
      >
        <div class="flex items-center gap-5">
          <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 flex items-center justify-center shrink-0">
            <UIcon
              name="i-lucide-plus"
              class="size-7 text-gray-600 dark:text-gray-400"
            />
          </div>
          <div>
        ...
        <UIcon
          ...
          class="absolute right-6 top-1/2 -translate-y-1/2 size-5 text-gray-300 group-hover:text-primary-500 group-hover:translate-x-1 transition-all"
        />
      </button>
