<template>
  <div class="max-w-[1200px] mx-auto">
    ...
    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-200 dark:border-white/[0.06]">
      <div>
        ...
        <p class="m-0 text-[0.9375rem] text-gray-600 dark:text-[#888]">
          Manage Stripe integration and payout preferences
        </p>
      </div>
      <UButton
        color="primary"
    ...
    >
        ...
        <div class="p-6">
          ...
          >
            <div class="flex items-start gap-5">
              ...
              <div class="flex-1">
                <h4 class="text-xl font-semibold m-0 mb-2 text-gray-900 dark:text-white">
                  Connected to Stripe
                </h4>
          ...
          >
            ...
            <div class="p-5 bg-amber-50 dark:bg-amber-500/5 border border-amber-200 dark:border-amber-500/15 rounded-xl">
              <h5 class="text-sm font-semibold m-0 mb-3 text-amber-600 dark:text-amber-400 uppercase tracking-wider">
                What you'll get:
              </h5>
              <ul class="m-0 p-0 list-none flex flex-col gap-2.5">
                <li class="flex items-center gap-3 text-[0.9375rem] text-gray-800 dark:text-[#e5e5e5]">
                  <UIcon
                    ...
                    class="w-[1.125rem] h-[1.125rem] text-amber-600 dark:text-amber-400 shrink-0"
                  />
      ...
      <UCard
        v-if="payments.stripeConnected"
        class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 ease-out hover:border-amber-200 dark:hover:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]"
      >
        <template #header>
          <div class="flex items-center gap-4">
            <div class="w-10 h-10 flex items-center justify-center bg-amber-100 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-[0.625rem] text-amber-600 dark:text-amber-400 shrink-0">
        ...
        <div class="p-6">
          <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between p-5 bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-xl">
              ...
              <div class="text-xl font-bold text-amber-600 dark:text-amber-400 tabular-nums">
          ...
          <div class="mt-4 p-5 bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-xl">
            <h5 class="text-sm font-semibold m-0 mb-4 text-gray-600 dark:text-[#888] uppercase tracking-wider">
              Example: $100 Booking
            </h5>
      ...
      >
        ...
        <div class="p-6">
          <UFormField label="Payout Frequency">
            <div class="flex flex-col gap-3 mt-2">
              ...
              >
                ...
                >
                  <div
                    v-if="payments.payoutSchedule === schedule.value"
...
const saveSettings = async () => {
  if (payments.value) {
    ...
    await updateSettings('payments', payments.value as any)
  }
}
</script>
