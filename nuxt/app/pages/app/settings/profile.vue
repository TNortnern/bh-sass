  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-200 dark:border-white/[0.06] max-md:flex-col max-md:items-start max-md:gap-4">
      <div>
        ...
        <p class="m-0 text-base text-gray-600 dark:text-[#888]">
          Manage your business information and service area
        </p>
      </div>
      <UButton
        color="primary"
        ...
        <div class="p-6 flex flex-col gap-6">
          ...
          >
            <div class="mt-2">
              ...
              <div
                v-if="business.logo"
                class="relative w-[120px] h-[120px] rounded-xl overflow-hidden border-2 border-amber-300 dark:border-amber-500/30"
              >
                <img
                  :src="business.logo"
                  alt="Business logo"
                ...
                >
                <button
                  class="absolute top-2 right-2 w-7 h-7 bg-black/80 border border-white/10 rounded-full flex items-center justify-center text-white cursor-pointer transition-all duration-200 hover:bg-red-500 hover:border-red-500"
              ...
              <div
                v-else
                class="w-[200px] p-8 border-2 border-dashed border-gray-300 dark:border-white/10 rounded-xl flex flex-col items-center gap-3 text-center transition-all duration-200 cursor-pointer hover:border-amber-300 hover:dark:border-amber-500/30 hover:bg-amber-50 hover:dark:bg-amber-500/[0.03]"
                @click="triggerLogoUpload"
              >
                <UIcon
                  v-if="uploadingLogo"
                  name="i-heroicons-arrow-path"
                  class="w-8 h-8 text-gray-500 dark:text-[#666] animate-spin"
                />
                <UIcon
                  v-else
                  name="i-heroicons-photo"
                  class="w-8 h-8 text-gray-500 dark:text-[#666]"
                />
        ...
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="m-0 text-sm text-gray-500 dark:text-[#666]">
                When you're available for rentals
              </p>
            </div>
          </div>
        </template>
        ...
        <div class="p-6 flex flex-col gap-6">
          ...
          <div class="mt-2 flex flex-col gap-3">
            ...
            >
              ...
              <div
                v-if="day.enabled"
                class="flex items-center gap-3 flex-1 max-md:w-full"
              >
                <UInput
                  v-model="day.open"
                  type="time"
              ...
              <span
                v-else
                class="text-gray-500 dark:text-[#666] text-sm italic"
              >Closed</span>
            </div>
          </div>
        </div>
        ...
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="m-0 text-sm text-gray-500 dark:text-[#666]">
                Define where you deliver rentals
              </p>
            </div>
          </div>
        </template>
        ...
        <div class="p-6 flex flex-col gap-6">
          ...
          >
            <div class="flex flex-wrap gap-2 mt-2">
              <div
                v-for="(zip, index) in business.serviceArea.zipCodes"
                :key="index"
                class="flex items-center gap-2 py-2 px-3 bg-amber-100 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-lg text-amber-700 dark:text-amber-400 text-sm font-medium tabular-nums"
              >
                <span>{{ zip }}</span>
                <button
                  class="flex items-center justify-center w-[18px] h-[18px] bg-black/30 border-none rounded-full text-amber-700 dark:text-amber-400 cursor-pointer transition-all duration-200 hover:bg-black/50"
...
const saveSettings = async () => {
  if (business.value) {
    await updateSettings('business', business.value as unknown as Record<string, unknown>)
  }
}
