<template>
  <div class="max-w-[1200px] mx-auto">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-200 dark:border-white/[0.06]">
      <div>
        <h2 class="text-2xl font-bold tracking-tight mb-1.5 text-gray-900 dark:text-white">Branding & Theming</h2>
        <p class="text-base text-gray-600 dark:text-[#888]">Customize your brand identity and widget appearance</p>
      </div>
      <UButton
        v-if="hasChanges"
        color="primary"
      ...
      <UCard class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 hover:border-amber-200 dark:hover:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]">
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              <h3 class="text-lg font-semibold tracking-tight mb-1 text-gray-900 dark:text-white">Brand Identity</h3>
              <p class="text-sm text-gray-500 dark:text-[#666] m-0">Logo and primary brand assets</p>
            </div>
          </div>
        </template>
        ...
        <div class="p-6">
          <div class="flex flex-col gap-6">
            <UFormField label="Company Logo" help="Used in emails, invoices, and widgets">
              <div class="flex flex-col gap-4">
                <div v-if="brandSettings.logo" class="relative w-[200px] h-[120px] border-2 border-dashed border-gray-200 dark:border-white/10 rounded-lg overflow-hidden bg-gray-50 dark:bg-black/20">
                  <img :src="brandSettings.logo" alt="Company Logo" class="w-full h-full object-contain p-4" />
                  <UButton
                    size="sm"
                    color="error"
                    variant="ghost"
                ...
                <div v-else class="w-[200px] h-[120px] border-2 border-dashed border-gray-200 dark:border-white/10 rounded-lg flex flex-col items-center justify-center gap-2 bg-gray-50 dark:bg-black/20">
                  <UIcon name="i-lucide-image" class="w-8 h-8 text-gray-400 dark:text-[#666]" />
                  <p class="m-0 text-sm text-gray-500 dark:text-[#666]">No logo uploaded</p>
                </div>
                <UButton
                  size="md"
                  color="primary"
            ...
            <UFormField label="Tagline" help="Optional short description">
              <UInput
      ...
      <UCard class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 hover:border-amber-200 dark:hover:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]">
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              <h3 class="text-lg font-semibold tracking-tight mb-1 text-gray-900 dark:text-white">Color Theme</h3>
              <p class="text-sm text-gray-500 dark:text-[#666] m-0">Customize widget and email colors</p>
            </div>
          </div>
        </template>
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6">
            <UFormField label="Primary Color" help="Main brand color">
            ...
            <UFormField label="Secondary Color" help="Accent and highlights">
              <div class="flex items-center gap-3">
                <input
            ...
            <UFormField label="Accent Color" help="Buttons and calls-to-action">
              <div class="flex items-center gap-3">
                <input
          ...
          <div class="mt-6 pt-6 border-t border-gray-200 dark:border-white/[0.06]">
            <p class="text-sm font-semibold text-gray-600 dark:text-[#888] mb-4 m-0">Quick Presets:</p>
            <div class="flex flex-col md:flex-row md:flex-wrap gap-3">
              ...
              >
                <div class="flex gap-1">
                  <div class="w-5 h-5 rounded border border-gray-200 dark:border-white/10" :style="{ backgroundColor: preset.primary }"></div>
                  <div class="w-5 h-5 rounded border border-gray-200 dark:border-white/10" :style="{ backgroundColor: preset.secondary }"></div>
                  <div class="w-5 h-5 rounded border border-gray-200 dark:border-white/10" :style="{ backgroundColor: preset.accent }"></div>
                </div>
      ...
      <UCard class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 hover:border-amber-200 dark:hover:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]">
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              <h3 class="text-lg font-semibold tracking-tight mb-1 text-gray-900 dark:text-white">Widget Preview</h3>
              <p class="text-sm text-gray-500 dark:text-[#666] m-0">See how your branding looks</p>
            </div>
          </div>
        </template>

        <div class="p-6">
          <div class="bg-white rounded-2xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.1)]" :style="widgetStyles">
            <div class="p-8 text-center bg-gradient-to-br from-[var(--primary-color)] to-[var(--secondary-color)]">
              ...
              />
              <div v-else class="w-[60px] h-[60px] mx-auto mb-4 flex items-center justify-center bg-white/20 rounded-lg">
                <UIcon name="i-lucide-castle" class="w-8 h-8 text-white" />
              </div>
              <h3 class="text-2xl font-bold text-white mb-2 m-0">{{ brandSettings.businessName || 'Your Business' }}</h3>
              <p v-if="brandSettings.tagline" class="text-sm text-white/90 m-0">
            ...
            <div class="p-8">
              <div class="flex gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex-1">
                  <h4 class="text-base font-semibold text-gray-900 mb-1 m-0">Princess Castle Bounce House</h4>
                  <p class="text-sm text-gray-600 m-0">$199/day</p>
                </div>
              </div>

              <button class="w-full px-3.5 py-3.5 border-0 rounded-lg text-base font-semibold text-white cursor-pointer transition-all duration-200 hover:translate-y-[-1px] hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" :style="buttonStyles">
                Book Now
              </button>
            </div>
          </div>
      ...
      <UCard class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 hover:border-amber-200 dark:hover:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]">
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              <h3 class="text-lg font-semibold tracking-tight mb-1 text-gray-900 dark:text-white">Email Templates</h3>
              <p class="text-sm text-gray-500 dark:text-[#666] m-0">Customize email appearance</p>
            </div>
          </div>
        </template>
      ...
      <UCard class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 hover:border-amber-200 dark:hover:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]">
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              <h3 class="text-lg font-semibold tracking-tight mb-1 text-gray-900 dark:text-white">Documents</h3>
              <p class="text-sm text-gray-500 dark:text-[#666] m-0">Invoice and contract customization</p>
            </div>
          </div>
        </template>
        ...
        <div class="p-6">
          <div class="flex flex-col gap-6">
            ...
            <UFormField label="Terms & Conditions" help="Shown on contracts">
              <UTextarea
            ...
            <UFormField label="Safety Guidelines" help="Shown on rental agreements">
              <UTextarea
