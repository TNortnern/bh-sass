  ...
  <div class="max-w-[1200px] mx-auto">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-200 dark:border-white/[0.06]">
      <div>
        ...
        <p class="text-base text-gray-600 dark:text-[#888]">
          Configure your public website and booking pages
        </p>
      </div>
    ...
    >
            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="m-0 text-sm text-gray-500 dark:text-[#666]">
                  Enable or disable your public website
                </p>
              </div>
            </div>
            <UToggle
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="p-4 bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-lg">
              <div class="flex items-center gap-2 mb-2">
                <UIcon
                  name="i-lucide-globe"
                  class="w-4 h-4 text-gray-500 dark:text-[#666]"
                />
        ...
        >
          <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-900/20 border border-gray-200 dark:border-white/[0.06] rounded-lg">
            <UIcon
              ...
              class="w-5 h-5 text-gray-500 dark:text-[#666] shrink-0 mt-0.5"
            />
        ...
        <template #header>
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="m-0 text-sm text-gray-500 dark:text-[#666]">
                Main banner at the top of your website
              </p>
            </div>
          </div>
        </template>
        ...
        <div class="p-6 flex flex-col gap-6">
          ...
          >
            <div class="mt-2">
              ...
              <div
                v-if="websiteConfig.heroImage"
                class="relative w-full max-w-[500px] h-[200px] rounded-xl overflow-hidden border-2 border-amber-300 dark:border-amber-500/30"
              >
                <img
                  :src="websiteConfig.heroImage"
                  alt="Hero image"
              ...
              <div
                v-else
                class="w-full max-w-[500px] p-8 border-2 border-dashed border-gray-300 dark:border-white/10 rounded-xl flex flex-col items-center gap-3 text-center transition-all duration-200 cursor-pointer hover:border-amber-300 hover:dark:border-amber-500/30 hover:bg-amber-50 hover:dark:bg-amber-500/[0.03]"
                @click="triggerHeroImageUpload"
              >
                <UIcon
                  v-if="uploadingHeroImage"
                ...
                <UButton
                  ...
                  @click.stop="triggerHeroImageUpload"
                >
                  Choose File
                </UButton>
              </div>
      ...
      <UCard class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 hover:border-amber-300 hover:dark:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]">
        ...
        >
          ...
          <div
            ...
            class="flex flex-col items-center justify-center py-12 gap-3 bg-gray-50 dark:bg-white/[0.02] rounded-lg border border-dashed border-gray-300 dark:border-white/10"
          >
            <UIcon
              name="i-lucide-quote"
          ...
          >
            ...
            >
              <div class="flex items-start justify-between gap-4">
                <div class="flex-1">
                  <p class="text-sm text-gray-700 dark:text-[#e5e5e5] mb-2 italic">
                    "{{ testimonial.quote }}"
                  </p>
      ...
      <UCard class="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden transition-all duration-300 hover:border-amber-300 hover:dark:border-amber-500/20 hover:shadow-[0_8px_32px_-8px_rgba(251,191,36,0.15)]">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="m-0 text-sm text-gray-500 dark:text-[#666]">
                  Showcase your events and rentals
                </p>
              </div>
            </div>
            <UToggle
        ...
        <div
          v-if="websiteConfig.showGallery"
          class="p-6 flex flex-col gap-6"
        >
          <div class="flex items-center justify-between mb-2">
            <p class="text-sm font-semibold text-gray-700 dark:text-[#e5e5e5]">
          ...
          <div
            v-if="websiteConfig.galleryImages.length === 0"
            class="flex flex-col items-center justify-center py-12 gap-3 bg-gray-50 dark:bg-white/[0.02] rounded-lg border border-dashed border-gray-300 dark:border-white/10"
          >
            <UIcon
              name="i-lucide-images"
...
const originalConfig = ref<WebsiteConfig>({
  enabled: false,
  heroTitle: '',
  heroSubtitle: '',
  heroCTA: 'Browse Rentals',
